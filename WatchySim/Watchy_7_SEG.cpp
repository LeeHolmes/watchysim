...
void Watchy7SEG::drawDate(){
    ...
    display.println((uint32_t) (currentTime.Year + YEAR_OFFSET));// offset from 1970, since year is stored in uint8_t
}
...
void Watchy7SEG::drawWeather(){
    ...
    display.getTextBounds(String(buffer), 0, 0, &x1, &y1, &w, &h);
    if(159 - w - x1 > 87){
